...
export default function QtySpinner(props) {
  ...
  return(<div>
   ...
   {value==0? ( <div style={{alignItems:'center',display:'flex',flexDirection:'row'}}><Button variant="contained" style={{background:'#1e6b7b',color:'#FFF',fontSize:14,width:200}} onClick={()=>handleIncreament()} >ADD TO CART</Button></div> ) :( <div style={{alignItems:'center',display:'flex',flexDirection:'row'}}><Avatar onClick={()=>handleDecreament()} style={{marginRight:15}} className={classes.orange} >-</Avatar>
