...
export default function GamesInterface(props)
  ...
  if (error)
{
  ...
  var result= await postDataAndImage('games/addnewgames',formData,config)
  if(result)
  {
    swal({
  ...
  return (<div className={classes.root}>
   ...
   <Grid item xs={12}>
      ...
      <Grid item xs={12}>
      <TextField onChange={(event)=>setGameDescription(event.target.value)} label="Description" variant="outlined" fullWidth/>
      </Grid>
      ...
      <Grid item xs={6}>
      <span style={{fontSize:16,fontWeight:300}}>Upload Game Picture</span>
